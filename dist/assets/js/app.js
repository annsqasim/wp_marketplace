...
(0, _jquery2.default)(function () {
  var h = (0, _jquery2.default)('#responsive-menu').height();

  (0, _jquery2.default)(window).scroll(function () {
    if ((0, _jquery2.default)(window).scrollTop() > h) {
      (0, _jquery2.default)('#responsive-menu').addClass('navbar-fixed');
    } else {
      (0, _jquery2.default)('#responsive-menu').removeClass('navbar-fixed');
    }
  });
